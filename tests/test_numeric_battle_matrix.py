...
# 实测基线（**2026-09-21 重采**；T15「出招窗口/前摇」全量生效后 —— 伤害落地时刻
# 从 T0 后移到 T0+出招：出招长的招在落地前敌人可能先动一格 ⇒ 平均回合普遍 +1.0~+2.0。
# 全表实数与机制解释见 `overnight/T15_NUMERIC_REVIEW.md`；此前的 2026-09-12 版本为
# numeric_sim 迁移到新引擎签名 + 装配与生产同源后的首轮基线）
MATRIX = {
    "战士": {"同级": (2, 11.38), "+5": (0, 7.50), "-5": (8, 6.25), "+11": (0, 4.75)},
    "法师": {"同级": (3, 7.25), "+5": (0, 5.25), "-5": (8, 4.75), "+11": (0, 3.12)},
    "牧师": {"同级": (1, 7.62), "+5": (0, 5.25), "-5": (8, 5.88), "+11": (0, 4.25)},
    "刺客": {"同级": (0, 8.00), "+5": (0, 5.25), "-5": (8, 5.25), "+11": (0, 4.12)},
    "游侠": {"同级": (0, 8.50), "+5": (0, 5.38), "-5": (8, 6.62), "+11": (0, 4.75)},
    "拳师": {"同级": (4, 10.38), "+5": (0, 6.88), "-5": (8, 5.38), "+11": (0, 4.75)},
}
