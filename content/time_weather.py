...
_SEASON_KEYS = {   # ★ B-1：id → 文案键（真源 = text_specs.json 的 season_name.*）
    "autumn": "season_name.autumn",
    "spring": "season_name.spring",
    "summer": "season_name.summer",
    "winter": "season_name.winter",
}
SEASON_CN = _T.names(_SEASON_KEYS, prefix="season_name")
_WEATHER_KEYS = {   # ★ B-1：id → 文案键（真源 = text_specs.json 的 weather_name.*）
    "cloudy": "weather_name.cloudy",
    "fog": "weather_name.fog",
    "rain": "weather_name.rain",
    "snow": "weather_name.snow",
    "storm": "weather_name.storm",
    "sunny": "weather_name.sunny",
}
WEATHER_CN = _T.names(_WEATHER_KEYS, prefix="weather_name")
