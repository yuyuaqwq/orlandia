...
_SHIELD_LOG_KEYS = {   # ★ B-1：id → 文案键（真源 = text_specs.json 的 shield_log.*）
    "atonement_shield": "shield_log.atonement_shield",
    "bedrock_crown": "shield_log.bedrock_crown",
    "echo_bless": "shield_log.echo_bless",
    "endless_radiance": "shield_log.endless_radiance",
    "firmament_crown": "shield_log.firmament_crown",
    "gargoyle_heart": "shield_log.gargoyle_heart",
}
_SHIELD_COND_LOG = _T.names(_SHIELD_LOG_KEYS, prefix="shield_log")
...
_EXTRA_LOG_KEYS = {   # ★ B-1：id → 文案键（真源 = text_specs.json 的 extra_log.*）
    "afterglow_splash": "extra_log.afterglow_splash",
    "annihilation_echo": "extra_log.annihilation_echo",
    "endless_blade": "extra_log.endless_blade",
    "hunter_open": "extra_log.hunter_open",
    "siren_fang": "extra_log.siren_fang",
    "spellblade_echo": "extra_log.spellblade_echo",
    "star_pierce": "extra_log.star_pierce",
    "wind_split": "extra_log.wind_split",
}
_EXTRA_LOG = _T.names(_EXTRA_LOG_KEYS, prefix="extra_log")
...
_CONTROL_LOG_KEYS = {   # ★ B-1：id → 文案键（真源 = text_specs.json 的 control_log.*）
    "everfrost_domain": "control_log.everfrost_domain",
    "everfrost_scepter": "control_log.everfrost_scepter",
    "frost_crown": "control_log.frost_crown",
    "frost_ring": "control_log.frost_ring",
    "holy_judgment_field": "control_log.holy_judgment_field",
    "holy_word_bind": "control_log.holy_word_bind",
    "time_freeze": "control_log.time_freeze",
}
_CONTROL_LOG = _T.names(_CONTROL_LOG_KEYS, prefix="control_log")
